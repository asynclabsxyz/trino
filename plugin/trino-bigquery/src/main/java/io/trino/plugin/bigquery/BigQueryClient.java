...
public class BigQueryClient
{
    ...
    public TableInfo getCachedTable(Duration viewExpiration, TableInfo remoteTableId, List<String> requiredColumns, ConnectorSession session, Optional<String> filter)
    {
