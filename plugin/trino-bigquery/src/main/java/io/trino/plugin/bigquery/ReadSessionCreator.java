...
public class ReadSessionCreator
{
    ...
    public ReadSession create(ConnectorSession session, TableId remoteTable, List<String> selectedFields, Optional<String> filter, int parallelism)
    {
        ...
        TableInfo actualTable = getActualTable(client, tableDetails, selectedFields, session, isViewMaterializationWithFilter(session) ? filter : Optional.empty());
            ...
            Optional<String> filter)
    {
        ...
        if (tableType == VIEW || tableType == MATERIALIZED_VIEW) {
            ...
            return client.getCachedTable(viewExpiration, remoteTable, requiredColumns, session, filter);
        }
